...
<html lang="en">
  <head>
    <title>FastTrack - Moving you ahead</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          ...
          <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
            ...
            <h1 class="text-white font-weight-light mb-5 text-uppercase font-weight-bold">Worldwide Logistics Services</h1>
            <p><a href="#" class="btn btn-primary py-3 px-5 text-white">Get Free Quote!</a></p>
      ...
      <div class="container">
        <div class="row text-center">
          <div class="col-md-12">
            ...
            <p class="mb-0"><a href="booking.html" class="btn btn-primary py-3 px-5 text-white">Get a Free Quote</a></p>
          </div>
        </div>
      </div>
    </div>
